...
module.exports = {
  ...
  'Rahvaraamat Assert Title': function(browser) {
    browser
      ...
      .pause(1000)
      .assert.title(
        'Raamatud, E-raamatud, E-lugerid, Filmid, Muusika | Rahva Raamat',
      )
      .pause(1000)
      .click(
        'a[href="/user/login/et?redirect=https%3A%2F%2Fwww.rahvaraamat.ee%2Fsite%2Fmessage%2Fet&layout=popup#TB_iframe?width=415&height=665"]',
      )
  ...
  'Login Page Loads': function(browser) {
    browser
      .url(
        'https://www.rahvaraamat.ee/user/login/et?redirect=https%3A%2F%2Fwww.rahvaraamat.ee%2Fsite%2Fmessage%2Fet&layout=popup',
      )
      .waitForElementVisible('body')
